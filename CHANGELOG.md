...
* Bug 1292099 - Disable FF Hello from running in FF 49 or later. (#584) [Mark Banner]

* No bug. Change the correct command for functional tests. rs=bustage-fix. [Mark Banner]

* No bug. Change the download option for functional tests to use an unbranded release build rather than nightly. rs=bustage-fix. [Mark Banner]

* Bug 1284423 - Add banner on the top of the Firefox Hello panel. r=dmose. [Andrei Oprea]

* Bug 1284806 - Investigate switching from Marionette to Selenium+geckodriver for functional tests. [Mark Banner]

* No bug. Fix functional test bustage from bug 1238128 landing in Firefox - whitelist the content server used for the test. rs=bustage-fix. [Mark Banner]

### Chores

* Update L10n from changeset 154c5e0dcfaebcca0449795a842f5b095f2e8ff8. [Mark Banner]

* Update fx-runner to version 1.0.5. r=Mardak. [Greenkeeper]

* Update jpm to version 1.1.2. r=Mardak. [Greenkeeper]

* Update karma to version 1.1.2. r=Mardak. [Greenkeeper]

* Update sinon to version 1.17.5. r=Mardak. [Greenkeeper]

* Update rimraf to version 2.5.4. r=Mardak. [Greenkeeper]

* Update babel-plugin-transform-es2015-parameters to version 6.11.4. r=Mardak. [Greenkeeper]

* Update karma-coverage to version 1.1.1. r=Mardak. [Greenkeeper]

* Update babel-cli to version 6.11.4. r=Mardak. [Greenkeeper]

* Update jpm to version 1.1.1. r=Mardak. [Greenkeeper]

* Update babel-plugin-transform-es2015-modules-commonjs to version 6.11.5. r=Mardak. [Greenkeeper]

* Update nodemon to version 1.10.0. r=Mardak. [Greenkeeper]
