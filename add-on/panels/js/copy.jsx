      ...
      return (
        <div className="copy-content">
          <div className="copy-body">
            <img className="copy-logo" src="shared/img/helloicon.svg" />
            <h1 className="copy-message">
              {mozL10n.get("copy_panel_message")}
              <label className="copy-toggle-label">
                <input onChange={this.handleToggle} type="checkbox" />
                {mozL10n.get("copy_panel_dont_show_again_label")}
              </label>
            </h1>
          </div>
          <button className="copy-button" onClick={this.handleCancel}>
            {mozL10n.get("copy_panel_cancel_button_label")}
          </button>
          <button className="copy-button" onClick={this.handleAccept}>
